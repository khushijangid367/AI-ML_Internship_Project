...
4. Rename the downloaded file to `serviceAccountKey.json` and place it in the root `Attendance_system` folder.
> **Note:** Never upload your `serviceAccountKey.json` to GitHub! Ensure it is listed in your `.gitignore`.
